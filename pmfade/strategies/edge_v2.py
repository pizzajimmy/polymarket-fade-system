...
class EdgeV2(Strategy):
    ...
    def evaluate(self, mv: MarketView, ctx: Context):
        ...
        # pre-gates: only markets in the tradeable shape get candidate rows at all
        ...
        gates: dict[str, bool] = {}
        gates["fade_shape"] = cheap_fv < cheap               # cheap side overpriced
        ...
        book_walked = False
        if gates["fade_shape"] and edge_gross - fee - spread_cost > 0 and mv.token_id_yes:
